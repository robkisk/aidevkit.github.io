...
**MCP Tools:** `manage_serving_endpoint`
...
**MCP Tools:** `manage_vs_endpoint`, `manage_vs_index`, `query_vs_index`, `manage_vs_data`
...
**MCP Tools:** `execute_sql`, `manage_serving_endpoint`
...
**MCP Tools:** `manage_ka`, `manage_mas`, `manage_genie`
...
**MCP Tools:** `execute_sql`, `execute_code`, `manage_volume_files`
