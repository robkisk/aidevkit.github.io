...
Custom Spark data sources that call external APIs need a consistent authentication strategy. This page covers priority-based credential resolution -- from Unity Catalog managed credentials down to API keys -- along with factory patterns and secure secret handling to keep credentials out of source code.
