...
Start here when building a new Python data source for Spark. This template provides a fully annotated skeleton covering the four modes -- batch read, batch write, stream read, and stream write -- so you can copy the structure and fill in your connector logic without guessing at the API surface.
