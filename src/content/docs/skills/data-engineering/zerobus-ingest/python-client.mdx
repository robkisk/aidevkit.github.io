---
title: Python Client
description: "Python SDK patterns for Zerobus Ingest: synchronous and asynchronous APIs, JSON and Protobuf flows, and a reusable client class."
sidebar:
  order: 2
---
...
`flush()`
`ingest_record(record)``json.dumps(record)`
