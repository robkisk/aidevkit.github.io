---
title: Lakebase Autoscaling Connection Patterns
description: This document covers different connection patterns for Lakebase Autoscaling, from simple scripts to production applications with token refresh.
sidebar:
  order: 99
---
