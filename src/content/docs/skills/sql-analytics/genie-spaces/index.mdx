...
**Key decisions:**
- **Inspect tables before creating** -- `get_table_details` reveals column names, types, and basic stats. This context drives better descriptions and sample questions, which directly affect Genie's SQL accuracy.
