...
Databricks SQL exposes Foundation Model APIs as built-in SQL functions, letting you classify, extract, summarize, and enrich data without leaving your SQL warehouse. Use these functions when you need LLM-powered transformations directly in queries, views, or materialized views alongside standard SQL logic.
